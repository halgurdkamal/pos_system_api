...
public class CreateSupplierCommandValidator : AbstractValidator<CreateSupplierCommand>
{
    ...
    {
        RuleFor(x => x.SupplierData).NotNull().WithMessage("Supplier data is required");

        When(
            x => x.SupplierData != null,
            () =>
            {
                ...
                RuleFor(x => x.SupplierData.SupplierType)
                    ...
                    .Must(BeValidSupplierType)
                    .WithMessage(
                        "Invalid supplier type. Valid values are: Manufacturer, Distributor, Wholesaler, LocalAgent"
                    );
                ...
                // Address validation
                RuleFor(x => x.SupplierData.Address).NotNull().WithMessage("Address is required");

                When(
                    x => x.SupplierData.Address != null,
                    () =>
                    {
    ...
    private bool BeValidSupplierType(string supplierType)
    {
        return Enum.TryParse<SupplierType>(supplierType, true, out _);
    }
}
