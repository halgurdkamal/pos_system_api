...
public static class ServiceCollectionExtensions
{
    public static IServiceCollection AddApplicationLayer(this IServiceCollection services)
    {
        ...
        services.AddScoped<ISalesStockService, SalesStockService>();
    ...
    {
        // Register DbContext and a pretty DB logger interceptor
        ...
        services.AddDbContext<ApplicationDbContext>(
            (serviceProvider, options) =>
                options
                    ...
                    // Add the interceptor instance resolved from the DI container
                    .AddInterceptors(
                        serviceProvider.GetRequiredService<pos_system_api.Infrastructure.Data.PrettyDbLoggerInterceptor>()
                    )
        );
        ...
        >();
        services.AddScoped<
            pos_system_api.Core.Application.Common.Interfaces.ICategoryRepository,
            pos_system_api.Infrastructure.Data.Repositories.CategoryRepository
        >();
        services.AddScoped<
            pos_system_api.Core.Application.Common.Interfaces.IShopRepository,
            pos_system_api.Infrastructure.Data.Repositories.ShopRepository
        >();
        services.AddScoped<
            pos_system_api.Core.Application.Common.Interfaces.ISupplierRepository,
            pos_system_api.Infrastructure.Data.Repositories.SupplierRepository
        >();
        services.AddScoped<
            pos_system_api.Core.Application.Common.Interfaces.IInventoryRepository,
            pos_system_api.Infrastructure.Data.Repositories.InventoryRepository
        >();
        services.AddScoped<
            pos_system_api.Core.Application.Common.Interfaces.IStockAdjustmentRepository,
            pos_system_api.Infrastructure.Data.Repositories.StockAdjustmentRepository
        >();
        services.AddScoped<
            pos_system_api.Core.Application.Common.Interfaces.IStockTransferRepository,
            pos_system_api.Infrastructure.Data.Repositories.StockTransferRepository
        >();
        services.AddScoped<
            pos_system_api.Core.Application.Common.Interfaces.IStockCountRepository,
            pos_system_api.Infrastructure.Data.Repositories.StockCountRepository
        >();
        services.AddScoped<
            pos_system_api.Core.Application.Common.Interfaces.IInventoryAlertRepository,
            pos_system_api.Infrastructure.Data.Repositories.InventoryAlertRepository
        >();
        services.AddScoped<
            pos_system_api.Core.Application.Common.Interfaces.IUserRepository,
            pos_system_api.Infrastructure.Data.Repositories.UserRepository
        >();
        services.AddScoped<
            pos_system_api.Core.Application.Common.Interfaces.IShopUserRepository,
            pos_system_api.Infrastructure.Data.Repositories.ShopUserRepository
        >();
        services.AddScoped<
            pos_system_api.Core.Application.Common.Interfaces.IShopPackagingOverrideRepository,
        ...
        services.AddScoped<
            pos_system_api.Core.Application.Common.Interfaces.IBarcodeService,
            pos_system_api.Infrastructure.Services.BarcodeService
        >();

        // Register purchase order repository
        services.AddScoped<
            pos_system_api.Core.Application.Common.Interfaces.IPurchaseOrderRepository,
    ...
    )
    {
        ...
        services.AddAuthorization(options =>
        {
                ...
                policy =>
                    policy.RequireAssertion(context =>
                        ...
                        || context.User.Claims.Any(c =>
                            c.Type.EndsWith(":isOwner") && c.Value == "True"
                        )
                    )
            );
            ...
            options.AddPolicy(
                "ShopAccess",
                policy => policy.Requirements.Add(new ShopAccessRequirement())
            );
        });
